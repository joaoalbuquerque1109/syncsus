    ...
    public function rules(): array
    {
        return [
            'document_type' => ['required', Rule::in([
                'medical_certificate', 'attendance_declaration', 'companion_declaration',
                'prescription', 'exam_request', 'referral', 'medical_report',
                'discharge_guidance', 'encounter_summary',
            ])],
            'title' => ['nullable', 'string', 'max:255'],
            'body' => ['required', 'string', 'min:10', 'max:16000'],
            'recipient_name' => ['nullable', 'string', 'max:255'],
            'starts_at' => ['nullable', 'date'],
            'duration_value' => ['nullable', 'required_if:document_type,medical_certificate', 'integer', 'min:1', 'max:365'],
